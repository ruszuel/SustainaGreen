...
const Scan = () => {
  ...
  const openSettingsAlert = () => {
    Alert.alert(
      ...
      'To use the scanner, SustainaGreen needs camera and location access. Please enable these permissions in Settings.',
      [
