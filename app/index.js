  ...
  return (
    <View className="gap-8 flex-1">
      ...
      <View style={{ paddingHorizontal: moderateScale(14) }}>
        ...
        <Text>
          <Text className="font-batangas text-secondary" style={{ fontSize: moderateScale(37) }}>Sustaina</Text>
          <Text className="font-batangas text-primary" style={{ fontSize: moderateScale(37) }}>Green</Text>
        </Text>
      </View>
      {/* Applicaiton purpose */}
