    ...
    <SafeAreaView className='px-5' style={{paddingTop: moderateScale(20)}}>
        ...
        <ScrollView bounces={false} showsVerticalScrollIndicator={false}>
            <View className='gap-y-7'>
                <View>
                    <Text className='font-batangas text-secondary' style={{fontSize: moderateScale(32)}}>About  
                        <Text className='text-primary'> us</Text>
                    </Text>
                </View>
                <View>
                    <Text className='font-plight text-justify' style={{fontSize: moderateScale(15)}}>
                        SustainaGreen is an innovative mobile application developed to raise environmental awareness and promote sustainable practices, 
                ...
                <View >
                    <Text className='font-plight text-justify' style={{fontSize: moderateScale(15)}}>
                        Moreover, SustainaGreen provides step-by-step procedures for recycling waste materials and guidelines on proper waste disposal. 
                ...
                <View>
                    <Text className='font-plight text-justify' style={{fontSize: moderateScale(15)}}>
                        SustainaGreen is specifically designed for use in the Philippines, with a dataset that includes images of Philippine 
                        solid waste materials. As such, it is designed to recognize and handle the country's particular waste management concerns.
                    </Text>
                </View>
                <View>
                    <Text className='font-plight text-justify' style={{fontSize: moderateScale(15)}}>
                        Join us in our mission to transform waste management practices and build a greener, more sustainable future with SustainaGreen. 
