          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View className='mb-5'>
              <View className='gap-y-7 mb-3'>
                ...
                <CustomText bold={'Purpose:'} light={'The purpose of this policy is to establish guidelines and regulations for the use of the Solid Waste Classification App SustainaGreen. The App is designed to assist users in classifying recyclable materials, specifically focusing on plastic, metal, and glass items.'}/>
                <CustomText bold={'Scope:'} light={'This policy applies to all users of the SustainaGreen App, including but not limited to individuals, organizations, and entities accessing the platform.'}/>
                
              </View>
              <View className='mb-3'>
                <Text className='font-pbold' style={{fontSize: moderateScale(16)}}>Guidelines:</Text>
                <CustomText bold={'1. Appropriate Use:'} light={'The SustainaGreen App is intended solely for the classification of plastic, metal, and glass items. Users are prohibited from uploading images that do not fall within these categories.'}/>
